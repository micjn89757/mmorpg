...
func (c *authClient) CheckToken(ctx context.Context, in *CheckTokenReq, opts ...grpc.CallOption) (*CheckTokenRes, error) {
	out := new(CheckTokenRes)
	err := c.cc.Invoke(ctx, "/service.Auth/checkToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) CheckToken(context.Context, *CheckTokenReq) (*CheckTokenRes, error) {
...
func _Auth_CheckToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Auth/checkToken",
	}
